...
I chose Ruby for this challenge. My solution is available in the ruby directory.

###Documentation

- Run tests to verify documentation.
- Read commits to know more about my workflow.

Please get in touch if anything is unclear. I will be happy to update.
